...
plt.plot(agelist, dpay, label=f'benefit  in Payments for {retirement_age1} vs {retirement_age2}  ', color="black", linewidth=2.5)
plt.plot(agelist, dinv, label=f'benefit  in Investment for {retirement_age1} vs {retirement_age2} ', color="green", linewidth=2.5)

# Add labels and legend
plt.xlabel('Age')
plt.ylabel('Cumulative Value (Payments and Investment)')
plt.title(f'Investment Growth with Interest Rate = {interest} FRA = {fra_age}')
plt.legend()
